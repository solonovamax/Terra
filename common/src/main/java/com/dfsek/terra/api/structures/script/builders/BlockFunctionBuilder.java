...
public class BlockFunctionBuilder implements FunctionBuilder<AbstractBlockFunction> {
    ...
    public AbstractBlockFunction build(List<Returnable<?>> argumentList, Position position) throws ParseException {
        ...
        if(dynamic)
            return new DynamicBlockFunction((Returnable<Number>) argumentList.get(0), (Returnable<Number>) argumentList.get(1),
                                            (Returnable<Number>) argumentList.get(2), (Returnable<String>) argumentList.get(3),
