...
public class DynamicBlockFunction extends AbstractBlockFunction {
    ...
    public DynamicBlockFunction(Returnable<Number> x, Returnable<Number> y, Returnable<Number> z, Returnable<String> data,
    ...
    public Void apply(ImplementationArguments implementationArguments, Map<String, Variable<?>> variableMap) {
        ...
        BlockData rot = data.computeIfAbsent(blockData.apply(implementationArguments, variableMap), main.getWorldHandle()::createBlockData)
                            .clone();
