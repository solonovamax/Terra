...
import static net.jafama.FastMath.max;
 ...
 * <br>
 * Nodes holding data in arrays, in the beginning the world just like ArrayList ,inserts data into array one by one when there is no space
 * for insertion to array
...
public class GlueList<T> extends AbstractList<T> implements List<T>, Cloneable, Serializable {
    ...
    protected static class Node<T> {
        ...
        public String toString() {
            return String.format("[sIndex: %d - eIndex: %d | elementDataPointer: %d | elementDataLength: %d]", startingIndex, endingIndex,
                                 elementDataPointer, elementData.length);
        }
