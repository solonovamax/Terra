...
public class BukkitBlockData implements BlockData {
    private static final boolean canUseWalls = VersionUtil.getMinecraftVersionInfo().getMinor() >= 16; // Fancy walls are only 1.16+
    ...
    public static BukkitBlockData newInstance(org.bukkit.block.data.BlockData bukkitData) {
        ...
        if(canUseWalls && bukkitData instanceof Wall) {
