...
public class TerraLevelType implements ForgeWorldType.IChunkGeneratorFactory {
    ...
    @Override
    public ChunkGenerator createChunkGenerator(Registry<Biome> biomeRegistry, Registry<DimensionSettings> dimensionSettingsRegistry,
                                               long seed, String generatorSettings) {
        ...
        logger.info("Creating generator for config pack " + pack.getTemplate().getID());
